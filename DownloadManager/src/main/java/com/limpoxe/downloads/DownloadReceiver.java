...
import static com.limpoxe.downloads.DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;
import static com.limpoxe.downloads.DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION;
...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (Intent.ACTION_BOOT_COMPLETED.equals(action)) {
            ...
            //ignore
            Log.d("DownloadReceiver", "action = " + action);
        }
    }

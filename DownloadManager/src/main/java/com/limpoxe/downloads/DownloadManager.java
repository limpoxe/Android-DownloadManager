...
public class DownloadManager {
    ...
    public final static String ACTION_DOWNLOAD_COMPLETE = "com.limpoxe.downloads.action.DOWNLOAD_COMPLETE";

    public final static String ACTION_NOTIFICATION_CLICKED =
            "com.limpoxe.downloads.action.DOWNLOAD_NOTIFICATION_CLICKED";

    public final static String ACTION_VIEW_DOWNLOADS = "com.limpoxe.downloads.action.VIEW_DOWNLOADS";
